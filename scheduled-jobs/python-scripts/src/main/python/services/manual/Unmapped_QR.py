...
df1 = spark.read.csv("/home/raja/Desktop/Ek_Step/Up text book/oct-2022/oct 18/18th Oct UP Textbook - QR Code Scans "
                     "18th Oct 2022.csv", header=True)

df4 = df1.filter(df1["derived_loc_district"].isin(city_list)).select("state_slug", "derived_loc_district",
                                                                     "SUM(total_count)")
