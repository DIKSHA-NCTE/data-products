...
def spark_init(spark_app_, container_name, account_name_, account_key_):
    ...
    # spark_ = SparkSession.builder.appName(spark_app_).getOrCreate();
...
process_failed_events('/home/analytics/lavanya/telemetry_failure/preprod_output', 'preprod', pre_date)
# process_failed_events('/home/analytics/lavanya/telemetry_failure/output1', 'prod', pre_date)
