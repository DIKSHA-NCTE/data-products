...
dir_name = '/home/analytics/lavanya/telemetry_failure/preprod_output/'+end_date+ '/sample'
subject = 'Pre-prod Failed Events'
...
shutil.make_archive('/home/analytics/lavanya/telemetry_failure/preprod_output/'+end_date+ '/sample','zip',dir_name)
...
body = "Hi All \nPlease find the attachment which includes [summary.csv & sample.zip] for preprod failed events \n \n Regards \n Lavanya KR"
msg.attach(MIMEText(body,'plain'))

files=['summary.csv','sample.zip']
for f in files:
   # dir_path= "/home/analytics/lavanya/telemetry_failure/prod_output123/2021-03-07/";
    dir_path= '/home/analytics/lavanya/telemetry_failure/preprod_output/'+end_date
