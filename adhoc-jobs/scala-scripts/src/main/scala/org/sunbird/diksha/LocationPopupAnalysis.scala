...
object LocationPopupAnalysis extends optional.Application {
  ...
  def print(date: String, totalDevices: Int, newDevicesStats: Tuple3[Int, Int, Int], oldDevicesStats: Tuple3[Int, Int, Int], newDevicesLocationStats: DeviceProfileOutput, oldDevicesLocationStats: DeviceProfileOutput)(implicit spark: SparkSession): Unit = {
