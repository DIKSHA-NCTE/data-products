...
object ReplayExtractorFailedEvents extends optional.Application {
  ...
  def main(from: String, to: String, brokerList: String, topic: String): Unit = {
    implicit val sparkContext: SparkContext = CommonUtil.getSparkContext(16, "ReplayExtractorFailedEvents")
  ...
  def execute(date: String, brokerList: String, topic: String)(implicit sc: SparkContext, fc: FrameworkContext): Unit = {
